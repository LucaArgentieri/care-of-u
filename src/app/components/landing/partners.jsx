  ...
  return (
    <div className="partners">
      ...
      <div className="images_container">
        <a target="_blank" href="https://www.asst-fbf-sacco.it/">
          {" "}
          <img src={FateBeneFratelli} alt="" />
        </a>
        <a target="_blank" href="https://www.humanitas.it/">
          {" "}
          <img src={Humanitas} alt="" />
        </a>
        <a target="_blank" href="https://www.ospedaleniguarda.it/">
          {" "}
        ...
        <a target="_blank" href="https://www.hsr.it/">
          {" "}
